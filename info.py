...
BOT_TOKEN = environ.get('BOT_TOKEN', "5481869179:AAEnvDCuHWh93X1TtJ5C2vNhgzOO4ov3ZPY")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Akash:jinahi@cluster0.uul7kyc.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001524622686'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Trickyakash5213')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "ɴᴀᴍᴇ: <code>{file_name}</code> \n\n [𝐅𝐫𝐞𝐞 𝐋𝐢𝐯𝐞 𝐂𝐫𝐢𝐜𝐤𝐞𝐭 𝐂𝐥𝐢𝐜𝐤 𝐇𝐞𝐫𝐞 🏏](https://urlsopen.net/kuDJ)\n [𝐅𝐫𝐞𝐞 𝐋𝐢𝐯𝐞 𝐒𝐩𝐨𝐫𝐭𝐬 𝐂𝐥𝐢𝐜𝐤 𝐇𝐞𝐫𝐞 ⚽️](https://urlsopen.net/kuDJ)\n [𝐅𝐫𝐞𝐞 𝐎𝐭𝐭 𝐖𝐞𝐛𝐬𝐞𝐫𝐢𝐞 𝐂𝐥𝐢𝐜𝐤 𝐇𝐞𝐫𝐞 😋](https://urlsopen.net/kuDJ)</b>")
